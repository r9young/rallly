...
// Types copied from the production code
...
// Helper functions copied from the production utils
...
export function removeAllOptionsForDay(options: DateTimeOption[], date: Date) {
...
/**
 * Minimal calendar component that mirrors the original month-calendar logic.
 */
